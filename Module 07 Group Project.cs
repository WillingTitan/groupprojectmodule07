        ...
        while (running)
        {
            ...
            switch (choice)
            {
                ...
                case "c": // remove any of the animals from the dictionary.
                    ...
                    switch (myDictionary.ContainsKey(keyToRemove))
                    {
                        case true:
                ...
                case "e": // edits an already existing key by adding a new element to it
                    Console.Write("\nEnter the key to add a value to: ");
                    string existingKey = Console.ReadLine();
                    switch (myDictionary.ContainsKey(existingKey))
                    {
                        case true:
                ...
                case "f": // organizes the keys alphabetically 
